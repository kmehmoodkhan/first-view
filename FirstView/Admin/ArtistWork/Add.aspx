<%@ Page Title="Artist Work Add" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="FirstView.Admin.ArtistWork.Add" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="page-header">
            <h4>Administration-Artist Work - Add</h4>
            <p class="lead">
            ...
            <div class="col-md-4">
                ...
                <div class="row marginTop" id="divWallPrice" runat="server">
                 ...
                 <div class="row marginTop" id="divArtistPrice" runat="server">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 align-middle">
                        ...
                        <div class="input-group">
                            <asp:TextBox ID="txtArtistPrice" runat="server" class="form-control" MaxLength="100"></asp:TextBox>
                            <br />
                ...
                <div class="row marginTop">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 align-middle">
                        ...
                        <div class="input-group">
                            <asp:TextBox ID="txtWidth" runat="server" class="form-control" MaxLength="9"></asp:TextBox>
                            <br />
