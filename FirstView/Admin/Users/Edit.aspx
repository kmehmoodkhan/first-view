<%@ Page Title="User Edit" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FirstView.Admin.Users.Edit" %>
 ...
 <script type="text/javascript">
    ...
    <div class="container">
        <div class="page-header">
            <h4>Administration - Users - Edit</h4>
            <p class="lead">
           ...
           <div class="row marginTop">
            ...
            <div class="col-md-4">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ValidationGroup="save" runat="server" ControlToValidate="txtName" SetFocusOnError="true" CssClass="text-danger" Display="Dynamic" ErrorMessage="Name is a required field"></asp:RequiredFieldValidator>                   
            </div>
        </div>
        <div class="row marginTop">
            <div class="col-md-2">
            ...
            <div class="col-md-4">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="save" runat="server" ControlToValidate="txtSurname" SetFocusOnError="true" CssClass="text-danger" Display="Dynamic" ErrorMessage="Surname is a required field"></asp:RequiredFieldValidator>                   
            </div>
        </div>
        <div class="row marginTop">
            <div class="col-md-2">
            ...
            <div class="col-md-4">
                ...
                <asp:RegularExpressionValidator ID="regexEmailValid" ValidationGroup="save" runat="server" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" CssClass="text-danger" Display="Dynamic" ControlToValidate="txtEmailAddress" ErrorMessage="Please provide a valid email."></asp:RegularExpressionValidator>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="save" runat="server" ControlToValidate="txtEmailAddress" SetFocusOnError="true" CssClass="text-danger" Display="Dynamic" ErrorMessage="Email Address is a required field"></asp:RequiredFieldValidator>                   
            </div>
        </div>
        <div class="row marginTop">
            <div class="col-md-2">
        ...
        <div class="row marginTop">
            <div class="col-md-2">
                <asp:Label ID="Label16" runat="server" Text="Is Verified?"></asp:Label>
            </div>
            <div class="col-md-4">
        ...
        <div class="row marginTop">
            <div class="col-md-2">
                <asp:Label ID="Label9" runat="server" Text="Is Artist?"></asp:Label>
            </div>
            <div class="col-md-4">
        ...
        <div class="row marginTop">
            <div class="col-md-2">
                <asp:Label ID="Label12" runat="server" Text="Town"></asp:Label>
            </div>
            <div class="col-md-4">
        ...
        <div class="row marginTop">
            <div class="col-md-2">
                <asp:Label ID="Label13" runat="server" Text="Post Code"></asp:Label>
            </div>
            <div class="col-md-4">
        ...
        <div class="row marginTop">
            <div class="col-md-2">
                <asp:Label ID="Label10" runat="server" Text="Change Password?"></asp:Label>
            </div>
            <div class="col-md-4">
                <asp:CheckBox ID="chkChangePass" runat="server" AutoPostBack="true" CausesValidation="false" OnCheckedChanged="chkChangePass_CheckedChanged" />
            </div>
        </div>
        <div class="row marginTop">
            <div class="col-md-2">
            ...
            <div class="col-md-4">
                <asp:TextBox ID="txtPassword" class="form-control" TextMode="Password" Enabled="false"  MaxLength="50"  Width="420px" runat="server" ></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvPassword" ValidationGroup="save" runat="server" ControlToValidate="txtPassword" SetFocusOnError="true" CssClass="text-danger" Display="Dynamic" ErrorMessage="Password is a required field"></asp:RequiredFieldValidator>                   
        ...
        <div class="row marginTop">
            ...
            <div class="col-md-4">
                <asp:TextBox ID="txtConfirmPassword" class="form-control" Enabled="false" TextMode="Password" MaxLength="50" Width="420px" runat="server" ></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvConfirmPassword" ValidationGroup="save" runat="server" ControlToValidate="txtConfirmPassword" SetFocusOnError="true" CssClass="text-danger" Display="Dynamic" ErrorMessage="Confirm Password is a required field"></asp:RequiredFieldValidator>                   
                <asp:CompareValidator ID="cvPass" ValidationGroup="save" ControlToValidate="txtConfirmPassword" ControlToCompare="txtPassword" CssClass="text-danger" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="The Passwords entered do not match."></asp:CompareValidator>
            </div>
        </div>
    </div>
