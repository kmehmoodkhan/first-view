<%@ Page Title="Personal Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProfileInformation.aspx.cs" Inherits="FirstView.Artist.ProfileInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function openModalUsernameExists() {
            $('#UserNameExistsModel').modal('show');
        } 
    </script>
    <div class="container">
    ...
    <div id="UserNameExistsModel" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        &times;</button>
                    <h4 class="modal-title">Username already taken by another user.</h4>
                </div>
                <div class="modal-body">
                    <p class="text-success">
